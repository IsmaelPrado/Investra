...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-5 border rounded shadow-md bg-gray-800 border-gray-700">
      ...
      <p className="text-lg font-semibold text-gray-300">Nombre de Usuario: {user.username}</p>
      <p className="text-lg font-semibold text-gray-300">Correo Electrónico: {user.email}</p>
    </div>
  );
};
